...
//        System.out.println("second Gemini Response ::: " + date.format(formatter));
//        System.out.println("second 소요시간 s ::: " + duration2.toSeconds() + " / ms ::: " + duration2.toMillis());
